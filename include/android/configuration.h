...
enum {
    ...
    /**
     * UI night mode: value that corresponds to NightQualifier "darkkatwhite"
     */
    ACONFIGURATION_UI_MODE_NIGHT_NO_DK_WHITEOUT = 0x4,
    /**
     * UI night mode: value that corresponds to NightQualifier "darkkatday"
     */
    ...
    /**
     * UI night mode: value that corresponds to NightQualifier "darkkatblack"
     */
